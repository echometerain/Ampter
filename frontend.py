...
class App(ctk.CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.appearanceModeLabel = ctk.CTkLabel(self.navigationPane, text = "Appearance Mode:")
        self.appearanceModeLabel.place()

        # Appearance Change Dropdown Menu
        self.appearanceMode = ctk.CTkOptionMenu(self.navigationPane, values = ["System", "Light", "Dark"], command = self.changeAppearance)
    ...
    def generateResults(self):
        filePath = ctk.filedialog.askopenfilename(filetypes = (("All Files", "*.*"), ("3G2 File", "*.3g2"), ("3GP File", "*.3gp"),
                                                               ...
                                                               ("EC3 File", "*.ec3"), ("FLAC File", "*.flac"), ("LATM File", "*.latm"),
                                                               ("LOAS File", "*.loas"), ("M4A File", "*.m4a"), ("M4B File", "*.m4b"),
                                                               ("M4R File", "*.m4r"), ("MOV File", "*.mov"), ("MP1 File", "*.mp1"), 
